      ...
      <nav class="bg-white shadow-md py-4">
        <div class="container mx-auto flex justify-between items-center">
          <div class="flex space-x-6 text-gray-700">
            <a href="#" class="hover:text-primary transition-colors duration-300">Mon profil</a>
            <a href="#" class="hover:text-primary transition-colors duration-300">Mon mot de passe</a>
            <a href="#" class="hover:text-primary transition-colors duration-300">Détails véhicules</a>
            <a href="#" class="hover:text-primary transition-colors duration-300">Notifications</a>
          </div>
        </div>
      </nav>
         ...
         <div class="bg-white p-4 shadow-md rounded-md">
              ...
              <div class="flex items-center justify-between bg-white shadow-md rounded-lg p-4">
                    <div>
                      ...
                      <p class="text-gray-600">Cette photo sera mise à votre profil</p>
                    </div>
                    <div class="w-16 h-16 rounded-full overflow-hidden">
                      <img src="https://th.bing.com/th/id/OIP.J4D2sw3inRpeyyZfUlHnvgHaFL?rs=1&pid=ImgDetMain" alt="Profile Photo" class="w-full h-full object-cover" />
                    </div>
...
<div class="bg-white p-4 shadow-md rounded-md">
              <h2 class="text-xl font-bold text-gray-800 mb-2">Mon mot de passe</h2>
              <div class="text-gray-600">
      ...
      <div class="mb-5">
        <label for="repeat-password" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Confirmez le Nouveau mot de passe</label>
        <input type="password" id="repeat-password" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light" required />
      </div>
      <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Mettre a jour</button>
